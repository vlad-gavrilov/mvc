    ...
    <div class="row justify-content-center pt-xl-5">
      <div class="col-12 col-lg-6 col-xl-4">
        <form class="form-signin border rounded p-5 shadow" action="#" method="post">
          ...
          <div class="h5 mb-4 font-weight-normal">Войти в личный кабинет</div>
          ...
          <hr>
          <p class="text-muted">Нет аккаунта? <a href="/user/register" class="text-decoration-none">Зарегистрируйтесь</a></p>
        </form>
      </div>
    </div>
  </div>
