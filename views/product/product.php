      ...
      <div class="product-view">
        <div class="product-essential">
          ...
          <div class="product-shop">
            ...
            <div class="f-fix mb-10"><a href="/category/<?php echo $product["category_id"]; ?>" class="prod-prev">Назад в категорию</a> <a class="prod-prev" href="#">PREV</a> <a class="prod-next" href="#">NEXT</a> </div>
            <!--Prev/Next Code End-->
            <!--Product Title-->
            ...
            <div class="price-box"> <span class="regular-price" id="product-price-167"> <span class="price">$<?php echo $product["price"]; ?></span> </span> </div>
            <div class="pro-left">
              ...
              <div class="review">
                ...
                <div class="size_guide"><a class="ajax" href="./images/size_chart.gif"><span>Click here to watch Size Guide</span> </a></div>
              </div>
            </div>
            <div class="pro-right">
          ...
          <div class="product-img-box">
            <p class="product-image product-image-zoom"> <a href="/upload/images/products/<?php echo $product["id"]; ?>.jpg" class='cloud-zoom' id='zoom1' rel="adjustX: 10, adjustY:-4"> <img style="max-height:400px; width:400px;" src="/upload/images/products/<?php echo $product["id"]; ?>.jpg" alt=''
                  title="Optional title display" /> </a> </p>
            <div class="more-views">
              <div class=" jcarousel-skin-tango">
                <ul id="more_view">
                  <li><a href="/upload/images/products/<?php echo $product["id"]; ?>.jpg" class='cloud-zoom-gallery' title='Thumbnail 1' rel="useZoom: 'zoom1', smallImage: "/upload/images/products/<?php echo $product["id"]; ?>.jpg" "> <img style="max-height:92px; width:92px;" src="/upload/images/products/<?php echo $product["id"]; ?>.jpg"
                        alt="Thumbnail 1" /></a></li>
                  <li><a href="/upload/images/products/<?php echo $product["id"]; ?>.jpg" class='cloud-zoom-gallery' title='Thumbnail 2' rel="useZoom: 'zoom1', smallImage: "/upload/images/products/<?php echo $product["id"]; ?>.jpg" "> <img style="max-height:90px; width:90px;" src="/upload/images/products/<?php echo $product["id"]; ?>.jpg"
                        alt="Thumbnail 2" /></a> </li>
                  <li><a href="/upload/images/products/<?php echo $product["id"]; ?>.jpg" class='cloud-zoom-gallery' title='Thumbnail 3' rel="useZoom: 'zoom1', smallImage: "/upload/images/products/<?php echo $product["id"]; ?>.jpg" "> <img style="max-height:90px; width:90px;" src="/upload/images/products/<?php echo $product["id"]; ?>.jpg"
                        alt="Thumbnail 3" /></a></li>
                  <li><a href="/upload/images/products/<?php echo $product["id"]; ?>.jpg" class='cloud-zoom-gallery' title='Thumbnail 3' rel="useZoom: 'zoom1', smallImage: "/upload/images/products/<?php echo $product["id"]; ?>.jpg" "> <img style="max-height:90px; width:90px;" src="/upload/images/products/<?php echo $product["id"]; ?>.jpg"
                        alt="Thumbnail 3" /></a></li>
                  <li><a href="/upload/images/products/<?php echo $product["id"]; ?>.jpg" class='cloud-zoom-gallery' title='Thumbnail 3' rel="useZoom: 'zoom1', smallImage: "/upload/images/products/<?php echo $product["id"]; ?>.jpg" "> <img style="max-height:90px; width:90px;" src="/upload/images/products/<?php echo $product["id"]; ?>.jpg"
                        alt="Thumbnail 3" /></a></li>
        ...
        <div class="product-collateral">
          ...
          <div class="product-tabs-content" id="product_tabs_description_contents">
            <h2>Details</h2>
            <div class="std"> Lorem ipsum dolor sit amet, consectetur adipiscing elit. Ut vel
              lorem eu metus placerat lacinia. Nunc arcu sapien, pulvinar a eleifend
              ut, fringilla eget felis. Praesent bibendum, sem id bibendum sagittis,
              massa lacus lobortis dui, vitae ornare nisl orci et massa. Vivamus ut
              nulla metus. Class aptent taciti sociosqu ad litora torquent per conubia
              nostra, per inceptos himenaeos. Suspendisse eros tortor, vehicula quis
              hendrerit a, dictum quis turpis. Nulla blandit tincidunt nibh eget
              tempus. Aliquam eleifend nisi nec nisl tempor non consectetur diam
              viverra. Cras cursus sodales neque sed mattis. Nunc id diam non massa
              porta pharetra sed et erat. Quisque pharetra dui ac justo imperdiet id
              tincidunt quam fringilla. </div>
          </div>
